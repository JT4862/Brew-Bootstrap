...
brew install "awscli" # Amazon Web Services command-line interface
...
brew install "brew-cask-completion" # Bash completion for Homebrew Cask
brew install "cmake" # Cross-platform make system
brew install "colordiff" # Tool to colorize 'diff' output
brew install "ctags" # Reimplementation of ctags(1)
brew install "diff-so-fancy" # Good-lookin' diffs with diff-highlight and more
brew install "dive" # Tool for exploring a docker image, layer contents, and discovering ways to shrink the size of your Docker/OCI image
